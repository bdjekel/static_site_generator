...
# Scenario (9): isolated delimiter, toggle off
                if word == delimiter and not delimiter_toggle:
                    if len(text_word_list) > 0:
                        word_list_helper(text_word_list, new_sub_nodes, TextType.TEXT)
                        # text_string: str = ' '.join(text_word_list) + ' '
    ...
    # Scenario (10): isolated delimiter, toggle on
                    ...
                    word_list_helper(delimited_word_list, new_sub_nodes, text_type)
...
def word_list_helper(word_list, sub_nodes, text_type):
