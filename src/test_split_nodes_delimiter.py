...
old_italic_nodes = [node_1_italic, node_2_italic, node_3_italic, node_4_italic]
old_bold_nodes = [node_1_bold, node_2_bold, node_3_bold, node_4_bold]
old_strikethrough_nodes = [node_1_strikethrough, node_2_strikethrough, node_3_strikethrough, node_4_strikethrough]

old_nodes_combined = old_italic_nodes + old_bold_nodes + old_strikethrough_nodes

expected_italic_nodes = expected_nodes_1_italic + expected_nodes_2_italic + expected_nodes_3_italic + expected_nodes_4_italic

expected_bold_nodes = expected_nodes_1_bold + expected_nodes_2_bold + expected_nodes_3_bold + expected_nodes_4_bold

expected_strikethrough_nodes = expected_nodes_1_strikethrough + expected_nodes_2_strikethrough + expected_nodes_3_strikethrough + expected_nodes_4_strikethrough
